...
if [ ! -e ${OUTDIR}/linux-stable/arch/${ARCH}/boot/Image ]; then
    ...
    # configure the current build
    make ARCH=${ARCH} CROSS_COMPILE=${CROSS_COMPILE} defconfig
    # NOTE: make all builds the following targets: vmlinux, Image, modules, and dtbs
    # check make help for more information
...
for F in ${SHLIB_ARR[@]}; do
    cp ${CROSS_SYSROOT}/lib64/$F ${OUTDIR}/rootfs/lib64/
done
